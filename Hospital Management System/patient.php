...
if (!isset($_SESSION['user_email'])) {
    header("Location: /HOSPITAL MANAGEMENT SYSTEM/login.html"); // Redirect to login if not logged in
    exit();
}
?>
...
<body>
  ...
  <div class="top-bar">
    <div class="container">
      ...
      <div class="auth-links">
        <span><span style="color: #ff7043; font-size: 24px;">👤</span>
  ...
  <section class="hero">
    <div class="container hero-content">
      ...
      <p>Your registered email is <strong><?php echo $_SESSION['user_email']; ?></strong></p>
